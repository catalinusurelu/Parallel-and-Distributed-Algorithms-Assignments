...
public class ReduceWorkPool {
	...
	LinkedList<ReducedPartialSolution> tasks = new LinkedList<ReducedPartialSolution>();
	 ...
	 */
	public synchronized ReducedPartialSolution getWork() {
	 ...
	 */
	synchronized void putWork(ReducedPartialSolution sp) {
